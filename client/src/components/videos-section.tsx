...
function VideosSection() {
  ...
  console.log('Videos Section - Products:', allProducts, 'Loading:', isLoading, 'Error:', error);
    ...
    <section id="videos" className="py-8 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="md:text-4xl font-montserrat font-bold text-dark mb-4 text-[25px]">Audios de Superación Personal</h2>
          <div className="w-20 h-1 bg-primary mx-auto mb-8"></div>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Contenido inspirador para superar obstáculos, mantener tu motivación al máximo nivel y 
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg mb-6">Próximamente nuevos audios</p>
          </div>
        ) : (
